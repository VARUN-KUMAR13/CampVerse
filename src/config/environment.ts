...
const currentEnv: Environment = getEnvVar(
  "VITE_NODE_ENV",
  "development",
) as Environment;
...
const firebaseConfig = {
  ...
  appId: getEnvVar(
    ...
    "1:730878450982:web:2a29ae46e611b1431235e7",
  ),
...
export const config: Config = {
  ...
  FEATURES: {
    ...
    ANALYTICS: getBooleanEnvVar(
      "VITE_FEATURE_ANALYTICS",
      currentEnv === "production",
    ),
    ERROR_REPORTING: getBooleanEnvVar(
  ...
  LIMITS: {
    ...
    SESSION_TIMEOUT: getNumericEnvVar(
  ...
  // UI Configuration
  UI: {
    DEFAULT_THEME: getEnvVar("VITE_DEFAULT_THEME", "system") as
      | "light"
      | "dark"
      | "system",
  ...
  MONITORING: {
    ...
    LOG_LEVEL: getEnvVar("VITE_LOG_LEVEL", "info") as
      | "debug"
      | "info"
      | "warn"
      | "error",
    PERFORMANCE_MONITORING: getBooleanEnvVar(
